...
\subsubsection{East facade shear walls}
The shear walls of the East facade are those denoted by the letter ``E'' in figures \ref{fg_3rd_floor_key_plan} to \ref{fg_1st_floor_key_plan}. The wind load on each floor per unit length are as follows:
...
The shear walls of the courtyard East and West facades are those denoted by the letters ``EC'' or ``WC'' in figures \ref{fg_3rd_floor_key_plan} to \ref{fg_1st_floor_key_plan}. The wind load on each floor per unit length are as follows:
